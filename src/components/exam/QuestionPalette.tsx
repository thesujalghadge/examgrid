  ...
  if (!exam || collapsed) {
    return (
      ...
      <button
        ...
        className="absolute right-0 top-1/2 z-10 -translate-y-1/2 rounded-l bg-primary px-1 py-6 text-xs text-primary-foreground shadow-md"
  ...
  return (
    <>
      ...
      <aside className="absolute inset-y-0 right-0 z-20 flex w-[min(280px,86vw)] shrink-0 flex-col bg-blue-50/30 md:static md:w-[300px]">
        <div className="flex items-center justify-between border-b border-gray-300 bg-primary px-3 py-2 text-primary-foreground">
        ...
        <div className="flex-1 overflow-y-auto px-2 py-2">
          {exam.sections.map((sec) => (
            <div key={sec.id} className="mb-3">
              <p className="mb-1.5 border-b border-gray-300 pb-1 text-[11px] font-bold uppercase tracking-wider text-primary">
                {sec.name}
              </p>
