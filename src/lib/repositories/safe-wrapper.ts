...
export function wrapStudentRepository(
  ...
  return withRepositoryLifecycle({
    ...
    list: () =>
      runSafe(name, "list", [] as InstituteStudent[], () => inner.list()),
    getById: (id) =>
      runSafe(name, "getById", undefined, () => inner.getById(id)),
    getByRollNumber: (rollNumber) =>
      runSafe(name, "getByRollNumber", undefined, () =>
        inner.getByRollNumber(rollNumber),
      ),
    save: (student) => runSafeVoid(name, "save", () => inner.save(student)),
    deactivate: (id) =>
      runSafeVoid(name, "deactivate", () => inner.deactivate(id)),
    delete: (id) => runSafeVoid(name, "delete", () => inner.delete(id)),
  }, inner);
}
...
export function wrapBatchRepository(inner: BatchRepository): BatchRepository {
  const name = "batches";
  return withRepositoryLifecycle({
    list: () => runSafe(name, "list", [] as Batch[], () => inner.list()),
    getById: (id) =>
      runSafe(name, "getById", undefined, () => inner.getById(id)),
    save: (batch) => runSafeVoid(name, "save", () => inner.save(batch)),
    archive: (id) => runSafeVoid(name, "archive", () => inner.archive(id)),
    delete: (id) => runSafeVoid(name, "delete", () => inner.delete(id)),
  }, inner);
}
...
export function wrapScheduleRepository(
  ...
  return withRepositoryLifecycle({
    list: () =>
      runSafe(name, "list", [] as ExamSchedule[], () => inner.list()),
    getById: (id) =>
      runSafe(name, "getById", undefined, () => inner.getById(id)),
    listByExamId: (examId) =>
      runSafe(name, "listByExamId", [] as ExamSchedule[], () =>
        inner.listByExamId(examId),
      ),
    save: (schedule) =>
      runSafeVoid(name, "save", () => inner.save(schedule)),
    deactivate: (id) =>
      runSafeVoid(name, "deactivate", () => inner.deactivate(id)),
    delete: (id) => runSafeVoid(name, "delete", () => inner.delete(id)),
  }, inner);
